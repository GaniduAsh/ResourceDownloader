...
@interface PinsViewController () <UICollectionViewDataSource, UICollectionViewDelegate>
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // Downlaod resources
    [[DownloadManager getSharedInstance] executeGetRequest:pin.largestImage.url.absoluteString parameters:nil completionBlock:^(BOOL succeeded, NSData *data) {
